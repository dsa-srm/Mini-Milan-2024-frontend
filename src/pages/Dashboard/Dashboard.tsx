...
const Dashboard = () => {
	...
	const { isLoading: urlLoading } = useBookTicket();
	...
	function handleBook() {
		...
		// 	userId: user.id,
		// });
		const result = resendEmail({
			user_id: "7e7315c5-2d14-44e9-bf27-bd5774378350",
			email: "am4821@srmist.edu.in",
			ticket_id: "faf66fbc-5038-4fd6-91ce-f8a2cfb5b54a",
			payment_id: "faf66fbc-5038-4fd6-91ce-f8a2cfb5b54a",
		});
		console.log(result);
	}
	...
	let message;
	if (
		user?.booking_info.payment_status === "success" &&
		user?.booking_info.ticket_status === "failed"
	) {
		message =
			"Ticket slots are fully booked! Your refund will be processed within 5-7 working days.";
