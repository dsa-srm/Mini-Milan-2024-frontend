...
const ArtistShowcase2 = (
  ...
  return (
    <div className="text-center h-[50vh] lg:h-[120vh] overflow-hidden bgsquare bg-contain  xl:bg-cover">
        ...
        <div>
            <div className="hidden md:block relative z-40 lg:text-[8vw] md:text-[7vw] text-[10vw] md:bottom-16 lg:-bottom-10  font-alinsa text-white  ">
                {name}
            </div>
