  ...
  return (
    <div className="relative bg-[#130025] h-screen lg:h-[125vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-0 max-md:h-screen">
        <img src={TopSVG} alt="Top Decorative Element" className='object-cover lg:object-cover w-full h-full ' />
      </div>

      {/* Bottom SVG */}
      <div className="absolute bottom-0 left-0 right-0 z-0 ">
        <img src={BottomSVG} alt="Bottom Decorative Element" className='object-cover w-full h-full ' />
      </div>
