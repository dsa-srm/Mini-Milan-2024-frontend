      ...
      <div className="max-w-full w-9/12 md:w-4/6 lg:w-4/6 bg-[#28242f] rounded-xl shadow-lg p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex flex-col">
            <label className="text-slate-100 text-sm md:text-lg lg:text-xl font-bold mb-2" htmlFor="name">NAME</label>
            <input
              type="text"
          ...
          {/* Phone Number Field */}
          <div className="flex flex-col">
            <label className="text-slate-100 text-sm md:text-lg lg:text-xl font-bold mb-2" htmlFor="phoneNumber">PHONE NUMBER</label>
            <input
              type="tel"
          ...
          <div className="flex flex-col">
            <label htmlFor="confirmPassword" className="text-slate-100 text-sm md:text-lg lg:text-xl font-bold mb-2">CONFIRM PASSWORD</label>
            <input
              type="password"
          ...
          <div className="flex flex-col">
            <label className="text-slate-100 text-sm md:text-lg lg:text-xl font-bold mb-2" htmlFor="registrationNumber">REGISTRATION NUMBER</label>
            <input
              type="text"
              {...register("registrationNumber", {
                required: "Registration number is required",
                validate: {
                  length: value => value.length === 15 || "Registration number must be exactly 15 characters long",
                  startsWithRA: value => value.startsWith('RA') || "Registration number must start with 'RA'",
                }
              })}
              className="form-input mt-1 block w-full border-gray-300 bg-[#71697e] rounded-md shadow-sm"
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="isSRMKTRStudent" className="mr-2 block text-slate-100 text-sm md:text-lg lg:text-xl  font-bold">STUDENT OF SRMKTR</label>
            <input
              type="checkbox"
              {...register("isSRMKTRStudent")}
              className="form-checkbox h-5 w-5 bg-[#71697e] text-blue-600"
              id="isSRMKTRStudent"
            />
          </div>
          ...
          {/* Gender Field */}
          <div className="flex flex-col">
            <label className="text-slate-100 text-sm md:text-lg lg:text-xl font-bold mb-2" htmlFor="gender">GENDER</label>
            <select
              {...register("gender", { required: "Gender is required" })}
              className="form-select px-[0.8rem] py-[1.2rem] text-[1.6rem] mt-1 block w-full bg-[#71697e] border-gray-300 rounded-md shadow-sm"
              id="gender"
            >
          ...
          <div className="text-center">
            <p className="text-slate-100">
              ...
              <a href="/login" className="text-blue-500 hover:text-blue-700 ml-2">Login.</a>
            </p>
          </div>
        </form>
      </div>
